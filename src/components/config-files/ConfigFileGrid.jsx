...
import { Box, SimpleGrid, VStack, Flex, Text, Icon, Code, HStack, Button } from '@chakra-ui/react';
import { MdSettings, MdDescription, MdVisibility, MdEdit } from 'react-icons/md';
      ...
      <VStack align="stretch" gap={3}>
        <Flex align="center" justify="space-between">
          <Text fontSize="lg" color={file.isMainConfig ? 'primary' : 'text'}>
            <Icon>
              {file.isMainConfig ? <MdSettings /> : <MdDescription />}
            </Icon>
          </Text>
          {file.isMainConfig && (
            <Box
